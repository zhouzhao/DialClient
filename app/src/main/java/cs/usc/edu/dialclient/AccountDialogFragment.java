 ...
 * {@link AccountDialogFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AccountDialogFragment#newInstance} factory method to
...
public class AccountDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_account_dialog, null);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                account.firstName = mFirstName.getText().toString();
                account.lastName = mLastName.getText().toString();
                mListener.onAccountAdd(account);
            }
